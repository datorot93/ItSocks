...
import { useFetchSeasonItems } from '../../hooks/useFetchSeasonItems';


export const ProductoListSeason = ({ isPack }) => {
  ...
  const { products } = useFetchSeasonItems(skip_page, setSkip, location);
