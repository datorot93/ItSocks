...
export const useCartReducer = () => {
  ...
  const modifyCartProduct = product => dispatch({
  ...
  return { state, addToCart, addPackToCart, removeFromCart, addOneToCart, subtractOneToCart, clearCart, modifyCartProduct }
}