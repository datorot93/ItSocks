...
@router.get("shippings_municipios", response_model=List[schemas.Shipping], response_model_exclude_none=True)
...
@router.get("shippings_departamentos", response_model=List[schemas.Shipping], response_model_exclude_none=True)
...
@router.get("municipiios_by_departamento", response_model=List[schemas.Shipping], response_model_exclude_none=True)
