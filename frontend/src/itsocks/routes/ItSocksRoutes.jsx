    ...
    <CartProvider>
      <ShippingProvider>
        ...
        <Routes>
          ...
          <Route path="packs/largas" element={ <PacksProducts categoria={"medias"} type={"largas"} /> } />
          <Route path="packs/largas/:nombre" element={ <PackProductDescription /> } />

          <Route path="packs/pantorrilleras" element={ <PacksProducts categoria={"medias"} type={"pantorrillera"} /> } />
          <Route path="packs/pantorrilleras/:nombre" element={ <PackProductDescription /> } />

          <Route path="packs/media_cania" element={ <PacksProducts categoria={"medias"} type={"media caña"} /> } />
          <Route path="packs/media_cania/:nombre" element={ <PackProductDescription /> } />
          ...
          <Route path="medias/tejidas" element={ <Personalizadas subcategory={"medias tejidas"}/> } />
          
          {/* ESTAMPADAS PANTORRILLERAS */}
          <Route path="medias/estampadas/pantorrillera" element={ <Productos categoria={ "medias" } subcategoria={"estampadas"} type={"pantorrillera"}/> } />
          <Route path="medias/estampadas/pantorrillera/:nombre" element={ <ProductDescription /> } />

          {/* ESTAMPADAS LARGAS  */}
          <Route path="medias/estampadas/larga" element={ <Productos categoria={ "medias" } subcategoria={"estampadas"} type={"largas"}/> } />
          <Route path="medias/estampadas/larga/:nombre" element={ <ProductDescription /> } />
          
          {/* ESTAMPADAS MEDIA CANIA  */}
          <Route path="medias/estampadas/media_cania" element={ <Productos categoria={ "medias" } subcategoria={"estampadas"} type={"media caña"}/> } />
          <Route path="medias/estampadas/media_cania/:nombre" element={ <ProductDescription /> } />



          {/* TEJIDAS PANTORRILLERAS */}
          <Route path="medias/tejidas/pantorrillera" element={ <Productos categoria={ "medias" } subcategoria={"tejidas"} type={"pantorrillera"}/> } />
          <Route path="medias/tejidas/pantorrillera/:nombre" element={ <ProductDescription /> } />

          {/* TEJIDAS LARGAS  */}
          <Route path="medias/tejidas/larga" element={ <Productos categoria={ "medias" } subcategoria={"tejidas"} type={"largas"}/> } />
          <Route path="medias/tejidas/larga/:nombre" element={ <ProductDescription /> } />
          
          {/* TEJIDAS MEDIA CANIA  */}
          <Route path="medias/tejidas/media_cania" element={ <Productos categoria={ "medias" } subcategoria={"tejidas"} type={"media caña"}/> } />
          <Route path="medias/tejidas/media_cania/:nombre" element={ <ProductDescription /> } />
          ...
          <Route path="carrito/billing/finish_order" element={ <FinishOrder /> } />
          <Route path="carrito/billing/billing_info" element={ <BillingInfo /> } />          
